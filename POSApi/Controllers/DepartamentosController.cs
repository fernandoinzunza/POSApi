...
namespace POSApi.Controllers
{
    ...
    public class DepartamentosController : ControllerBase
    {
        ...
        public DepartamentosController(POSContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Departamento>> PostDepartamento([FromBody]JsonElement obj)
        {
            var departamento = JsonSerializer.Deserialize<Departamento>(obj.ToString());
